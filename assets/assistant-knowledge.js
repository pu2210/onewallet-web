...
window.ONEWALLET_ASSISTANT = (function () {
  const STR = {
    en: {
      ...
      fallback: 'I can only answer from the current public homepage and whitepaper draft. Try asking about wallet setup, Multi-Share (Shamir) security, recovery, payments, fees, $1 utility, roadmap, risks, or community channels.',
      intents: {
        greeting: "Hi — I'm the ONEWALLET AI Assistant. I can help with wallet setup, Multi-Share security, payments, $1 utility, roadmap, risks, and community channels. What would you like to know?",
        courtesy: 'Anytime. Ask another question whenever you are ready.',
        capability: 'I answer questions grounded in the public ONEWALLET homepage and whitepaper. Best topics: wallet setup, Multi-Share (Shamir) security and recovery, payments and fees, the $1 utility, roadmap, risks, and community channels.',
        ...
        unsupportedDomain: "That's outside what I can answer. I can help with ONEWALLET wallet, Multi-Share security, payments, $1 utility, roadmap, risks, and community channels.",
      ...
      items: [
        ...
        { id: 'custody', featured: true, q: 'Is ONEWALLET custodial?', a: 'No single party can move funds. The target custody model is 2-of-3 Shamir across device, Telegram, and recovery shares. Any two are combined on your device in an isolated context to sign, then wiped. Any one share alone — including the Telegram share — cannot reconstruct the key or sign a transaction.', href: '#security', link: 'Security model', k: 'custody custodial shamir multi-share key security sign share telegram self' },
        { id: 'recovery', q: 'What happens if I lose my device or Telegram account?', a: 'Recovery is designed around issuing a fresh device share and validating it through the recovery share. Losing a device or Telegram session should not give the Telegram share enough authority to move funds alone — a second share is still required.', href: 'whitepaper.html#ch5', link: 'Security chapter', k: 'lose device telegram recovery account share rotate' },
        { id: 'seed', q: 'Do I need a seed phrase?', a: 'Not by default. ONEWALLET uses Multi-Share (Shamir) custody, so there is no single seed phrase a normal user must hold. Advanced backup or export behavior remains subject to product and security approval.', href: '#faq', link: 'FAQ', k: 'seed phrase backup key shamir multi-share' },
        ...
        { id: 'payments', featured: true, q: 'How do merchant payments work?', a: 'A merchant generates a QR invoice. The user scans it inside Telegram. ONEWALLET previews receiver, fees, and FX, Shamir signing completes the transaction, and a settlement webhook supports POS reconciliation.', href: '#payments', link: 'Payments section', k: 'payment merchant qr invoice webhook settlement pos stablecoin checkout' },
        ...
        { id: 'whitepaper', q: 'Where should I read the details?', a: 'The whitepaper is the detailed product and technical reference. It covers executive summary, product thesis, UX, architecture, security, token model, growth, business model, roadmap, team, risks, and glossary.', href: 'whitepaper.html', link: 'Read whitepaper', k: 'whitepaper details documentation chapters glossary architecture pdf' },
          { id: 'team', q: 'Who is behind ONEWALLET?', a: 'The latest foundation update lists ONE COMPANY as a Malaysia foundation registered with SSM, Companies Commission of Malaysia. The public team section lists Chiba Mitsuru as Foundation Chair, James Kim as CEO, Kim Jae Mo as Director CMO, Max Khoo as Director CFO, Lee Jun Bong as Director, and Park Ju-Jin as Director. Chiba Mitsuru is also listed as Representative Director of REMOTEX JAPAN Co., Ltd. and Representative of ITCOM INTERNATIONAL LLC. Park Ju-Jin is listed with previous roles at SearchOne, Tongil Trading, HighGood, and CrossCoin Foundation.', href: '#team', link: 'Team section', k: 'team founders governance foundation malaysia ssm one company directors people legal registration address chiba mitsuru remotex japan itcom international park ju-jin searchone tongil trading highgood crosscoin' },
    ...
    ko: {
      ...
      fallback: '현재 공개 홈페이지와 백서 초안에 있는 내용만 답변할 수 있습니다. 지갑 개설, Multi-Share(Shamir) 보안, 복구, 결제, 수수료, $1 유틸리티, 로드맵, 리스크 또는 커뮤니티 채널에 대해 물어보세요.',
      intents: {
        greeting: '안녕하세요. ONEWALLET AI 어시스턴트입니다. 지갑 개설, Multi-Share 보안, 결제, $1 유틸리티, 로드맵, 리스크, 커뮤니티 채널에 대해 도와드릴 수 있어요. 무엇이 궁금하신가요?',
        courtesy: '언제든지요. 다음 질문도 편하게 물어보세요.',
        capability: 'ONEWALLET 공개 홈페이지와 백서 자료를 근거로 답변합니다. 지갑 개설, Multi-Share(Shamir) 보안과 복구, 결제와 수수료, $1 유틸리티, 로드맵, 리스크, 커뮤니티 채널 질문에 가장 잘 답할 수 있어요.',
        benignOfftopic: 'ONEWALLET 관련 질문을 도와드릴 수 있어요. 지갑, 결제, 보안, $1 유틸리티, 로드맵, 커뮤니티 주제로 물어봐 주세요.',
        unsupportedDomain: '그 주제는 제가 답변드릴 수 있는 범위 밖이에요. ONEWALLET 지갑, Multi-Share 보안, 결제, $1 유틸리티, 로드맵, 리스크, 커뮤니티 채널에 대해 도와드릴 수 있습니다.',
      ...
      items: [
        { id: 'what', featured: true, q: 'ONEWALLET은 무엇을 하나요?', a: 'ONEWALLET은 Telegram 안에서 작동하는 Web3 지갑이자 결제 레일입니다. 무시드 Multi-Share 커스터디, QR 결제, 머천트 도구, $1 유틸리티를 하나의 Mini App 흐름으로 연결합니다.', href: 'whitepaper.html#ch1', link: '요약 읽기', k: '무엇 제품 지갑 결제 telegram mini app' },
        ...
        { id: 'custody', featured: true, q: 'ONEWALLET은 커스터디 방식인가요?', a: '단일 주체가 자금을 이동할 수 없도록 설계합니다. 목표 커스터디 모델은 기기·텔레그램·복구 분산 키를 사용하는 2-of-3 Shamir입니다. 임의의 2개가 사용자 기기의 격리된 컨텍스트에서 키를 잠시 재구성해 서명한 뒤 폐기합니다. 텔레그램 분산 키 하나만으로는 키를 재구성하거나 거래에 서명할 수 없습니다.', href: '#security', link: '보안 모델', k: '커스터디 shamir multi-share 보안 서명 분산키 텔레그램' },
        ...
        { id: 'seed', q: '시드 문구가 필요한가요?', a: '기본적으로 필요하지 않습니다. ONEWALLET은 Multi-Share(Shamir) 커스터디를 사용하므로 일반 사용자가 관리해야 하는 단일 시드 문구가 없습니다. 고급 백업이나 내보내기 기능은 제품·보안 승인 범위로 남겨야 합니다.', href: '#faq', link: 'FAQ', k: '시드 문구 백업 키 shamir multi-share' },
        ...
        { id: 'payments', featured: true, q: '머천트 결제는 어떻게 작동하나요?', a: '머천트가 QR 인보이스를 만들고, 사용자가 Telegram 안에서 스캔합니다. ONEWALLET은 수신자, 수수료, 환율을 미리 보여주고, Shamir 서명 후 정산 Webhook으로 POS 대조를 지원합니다.', href: '#payments', link: '결제 섹션', k: '결제 머천트 qr 인보이스 webhook 정산 pos 스테이블코인' },
        ...
        { id: 'whitepaper', q: '자세한 내용은 어디서 보나요?', a: '백서가 제품 및 기술 상세 기준 문서입니다. 요약, 제품 논리, UX, 아키텍처, 보안, 토큰 모델, 성장, 비즈니스 모델, 로드맵, 팀, 리스크, 용어집을 다룹니다.', href: 'whitepaper.html', link: '백서 읽기', k: '백서 자세한 문서 장 용어집 아키텍처' },
          { id: 'team', q: 'ONEWALLET 팀은 어떻게 구성되어 있나요?', a: '최신 재단 업데이트는 ONE COMPANY를 말레이시아 SSM(Companies Commission of Malaysia)에 등록된 말레이시아 재단으로 기재합니다. 공개 팀 섹션에는 Chiba Mitsuru 재단 의장, James Kim CEO, Kim Jae Mo 이사 CMO, Max Khoo 이사 CFO, Lee Jun Bong 이사, Park Ju-Jin 이사가 표시됩니다. Chiba Mitsuru는 REMOTEX JAPAN 주식회사 대표이사와 ITCOM INTERNATIONAL 합동회사 대표로도 기재되어 있으며, Park Ju-Jin은 SearchOne, Tongil Trading, HighGood, CrossCoin Foundation의 이전 역할도 함께 기재되어 있습니다.', href: '#team', link: '팀 섹션', k: '팀 재단 말레이시아 ssm one company 이사 거버넌스 chiba mitsuru remotex japan itcom international park ju-jin searchone tongil highgood crosscoin' },
    ...
    ja: {
      ...
      fallback: '現在の公開ホームページとホワイトペーパー草案にある内容だけ回答できます。ウォレット作成、Multi-Share(Shamir) セキュリティ、復旧、決済、手数料、$1 ユーティリティ、ロードマップ、リスク、コミュニティチャンネルについて質問してください。',
      intents: {
        greeting: 'こんにちは。ONEWALLET AI アシスタントです。ウォレット作成、Multi-Share セキュリティ、決済、$1 ユーティリティ、ロードマップ、リスク、コミュニティチャンネルについてお手伝いできます。何をお探しですか？',
        courtesy: 'どういたしまして。次の質問もお気軽にどうぞ。',
        capability: 'ONEWALLET の公開ホームページとホワイトペーパーを根拠に回答します。得意分野は、ウォレット作成、Multi-Share(Shamir) セキュリティと復旧、決済と手数料、$1 ユーティリティ、ロードマップ、リスク、コミュニティチャンネルです。',
        benignOfftopic: 'ONEWALLET についてのお手伝いができます。ウォレット、決済、セキュリティ、$1 ユーティリティ、ロードマップ、コミュニティのテーマでぜひお試しください。',
        unsupportedDomain: 'そのテーマはお答えできる範囲外です。ONEWALLET のウォレット、Multi-Share セキュリティ、決済、$1 ユーティリティ、ロードマップ、リスク、コミュニティチャンネルについてはお手伝いできます。',
      ...
      items: [
        { id: 'what', featured: true, q: 'ONEWALLET は何をするものですか？', a: 'ONEWALLET は Telegram ネイティブの Web3 ウォレット兼決済レールです。キーレス Multi-Share カストディ、QR 決済、加盟店ツール、$1 ユーティリティを Telegram の Mini App 内でつなぎます。', href: 'whitepaper.html#ch1', link: '概要を見る', k: 'what product wallet payment telegram mini app' },
        ...
        { id: 'custody', featured: true, q: 'ONEWALLET はカストディ型ですか？', a: '単一の当事者だけでは資金を動かせません。目標カストディモデルは、デバイス、Telegram、復旧シェアによる 2-of-3 Shamir です。任意の2つがユーザー端末の隔離されたコンテキストで鍵を一時的に再構成して署名し、直後に破棄します。Telegramシェア単体では、鍵の再構成も取引への署名もできません。', href: '#security', link: 'セキュリティモデル', k: 'custody shamir multi-share security sign share telegram' },
        ...
        { id: 'seed', q: 'シードフレーズは必要ですか？', a: '標準では不要です。ONEWALLET は Multi-Share(Shamir) カストディを使うため、通常ユーザーが管理する単一のシードフレーズはありません。高度なバックアップやエクスポートは、製品・セキュリティ承認の対象です。', href: '#faq', link: 'FAQ', k: 'seed phrase backup key shamir multi-share' },
        ...
        { id: 'payments', featured: true, q: '加盟店決済はどう動きますか？', a: '加盟店が QR 請求を作成し、ユーザーが Telegram 内でスキャンします。ONEWALLET は受取先、手数料、為替プレビューを表示し、Shamir 署名後に決済 Webhook で POS 照合を支援します。', href: '#payments', link: '決済セクション', k: 'payment merchant qr invoice webhook settlement pos stablecoin' },
        ...
        { id: 'whitepaper', q: '詳細はどこで読めますか？', a: 'ホワイトペーパーが製品・技術の詳細リファレンスです。概要、製品論点、UX、アーキテクチャ、セキュリティ、トークンモデル、成長、ビジネスモデル、ロードマップ、チーム、リスク、用語集を扱います。', href: 'whitepaper.html', link: 'ホワイトペーパーを読む', k: 'whitepaper details documentation chapters glossary architecture' },
          { id: 'team', q: 'ONEWALLET のチームは？', a: '最新の財団アップデートでは、ONE COMPANY はマレーシアの SSM（Companies Commission of Malaysia）に登録されたマレーシア財団として記載されています。公開チームセクションには、財団議長の Chiba Mitsuru、CEO の James Kim、Director CMO の Kim Jae Mo、Director CFO の Max Khoo、Director の Lee Jun Bong と Park Ju-Jin が掲載されています。Chiba Mitsuru は REMOTEX JAPAN株式会社の代表取締役、ITCOM INTERNATIONAL合同会社の代表としても記載されています。Park Ju-Jin には SearchOne、Tongil Trading、HighGood、CrossCoin Foundation での過去の役職も記載されています。', href: '#team', link: 'チームセクション', k: 'team founders governance foundation malaysia ssm one company directors people chiba mitsuru remotex japan itcom international park ju-jin searchone tongil highgood crosscoin' },
    ...
    zh: {
      ...
      fallback: '我只能根据当前公开主页和白皮书草稿回答。可以询问钱包开通、Multi-Share(Shamir) 安全、恢复、支付、费用、$1 效用、路线图、风险或社区频道。',
      intents: {
        greeting: '你好，我是 ONEWALLET AI 助手。可以帮你了解钱包开通、Multi-Share 安全、支付、$1 效用、路线图、风险和社区频道。请问想了解什么？',
        courtesy: '不客气，随时再问。',
        capability: '我基于 ONEWALLET 公开主页和白皮书作答。擅长的主题：钱包开通、Multi-Share(Shamir) 安全与恢复、支付与费用、$1 效用、路线图、风险和社区频道。',
        benignOfftopic: '我专注于 ONEWALLET 相关问题。可以问问钱包、支付、安全、$1 效用、路线图或社区频道。',
        unsupportedDomain: '这超出我能回答的范围。我可以帮你了解 ONEWALLET 钱包、Multi-Share 安全、支付、$1 效用、路线图、风险和社区频道。',
      ...
      items: [
        { id: 'what', featured: true, q: 'ONEWALLET 是做什么的？', a: 'ONEWALLET 是原生于 Telegram 的 Web3 钱包和支付通道。它把无种子短语 Multi-Share 托管、QR 支付、商户工具和 $1 效用整合到 Telegram Mini App 中。', href: 'whitepaper.html#ch1', link: '执行摘要', k: 'what product wallet payment telegram mini app' },
        ...
        { id: 'custody', featured: true, q: 'ONEWALLET 是托管型吗？', a: '没有任何单一主体可以移动资金。目标托管模型是设备、Telegram 和恢复分片组成的 2-of-3 Shamir。任意两个在用户设备的隔离环境中短暂重构密钥以完成签名，随后销毁。任何单一分片，包括 Telegram 分片，都无法独立重构密钥或签名交易。', href: '#security', link: '安全模型', k: 'custody shamir multi-share security sign share telegram' },
        ...
        { id: 'seed', q: '需要助记词吗？', a: '默认不需要。ONEWALLET 使用 Multi-Share(Shamir) 托管，因此普通用户不需要管理单一助记词。高级备份或导出行为仍应经过产品和安全审批。', href: '#faq', link: 'FAQ', k: 'seed phrase backup key shamir multi-share' },
        ...
        { id: 'payments', featured: true, q: '商户支付如何工作？', a: '商户生成 QR 发票，用户在 Telegram 内扫描。ONEWALLET 预览收款方、费用和汇率，Shamir 签名后通过结算 Webhook 支持 POS 对账。', href: '#payments', link: '支付部分', k: 'payment merchant qr invoice webhook settlement pos stablecoin' },
        ...
        { id: 'whitepaper', q: '在哪里阅读详细信息？', a: '白皮书是详细的产品和技术参考，涵盖执行摘要、产品论点、UX、架构、安全、代币模型、增长、商业模型、路线图、团队、风险和术语表。', href: 'whitepaper.html', link: '阅读白皮书', k: 'whitepaper details documentation chapters glossary architecture' },
          { id: 'team', q: 'ONEWALLET 团队是谁？', a: '最新基金会更新显示，ONE COMPANY 是在马来西亚 SSM（Companies Commission of Malaysia）注册的马来西亚基金会。公开团队部分列出 Chiba Mitsuru 为基金会主席、James Kim 为 CEO、Kim Jae Mo 为 Director CMO、Max Khoo 为 Director CFO、Lee Jun Bong 与 Park Ju-Jin 为 Director。Chiba Mitsuru 还列为 REMOTEX JAPAN株式会社代表取締役、ITCOM INTERNATIONAL合同会社代表。Park Ju-Jin 还列有 SearchOne、Tongil Trading、HighGood 与 CrossCoin Foundation 的过往职务。', href: '#team', link: '团队部分', k: 'team founders governance foundation malaysia ssm one company directors people chiba mitsuru remotex japan itcom international park ju-jin searchone tongil highgood crosscoin' },
