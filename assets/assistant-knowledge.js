    ...
    en: {
      ...
      items: [
        ...
        { id: 'whitepaper', q: 'Where should I read the details?', a: 'The whitepaper is the detailed product and technical reference. It covers executive summary, product thesis, UX, architecture, security, token model, growth, business model, roadmap, team, risks, and glossary.', href: 'whitepaper.html', link: 'Read whitepaper', k: 'whitepaper details documentation chapters glossary architecture pdf' },
          { id: 'team', q: 'Who is behind ONEWALLET?', a: 'The latest foundation update lists ONE COMPANY as a Malaysia foundation registered with SSM, Companies Commission of Malaysia. The public team section lists James Kim as CEO, Kim Jae Mo as Director CMO, Max Khoo as Director CFO, Lee Jun Bong as Director, and Park Ju-Jin as Director. Park Ju-Jin is also listed with previous roles at SearchOne, Tongil Trading, HighGood, and CrossCoin Foundation.', href: '#team', link: 'Team section', k: 'team founders governance foundation malaysia ssm one company directors people legal registration address park ju-jin searchone tongil trading highgood crosscoin' },
    ...
    ko: {
      ...
      items: [
        ...
        { id: 'whitepaper', q: '자세한 내용은 어디서 보나요?', a: '백서가 제품 및 기술 상세 기준 문서입니다. 요약, 제품 논리, UX, 아키텍처, 보안, 토큰 모델, 성장, 비즈니스 모델, 로드맵, 팀, 리스크, 용어집을 다룹니다.', href: 'whitepaper.html', link: '백서 읽기', k: '백서 자세한 문서 장 용어집 아키텍처' },
          { id: 'team', q: 'ONEWALLET 팀은 어떻게 구성되어 있나요?', a: '최신 재단 업데이트는 ONE COMPANY를 말레이시아 SSM(Companies Commission of Malaysia)에 등록된 말레이시아 재단으로 기재합니다. 공개 팀 섹션에는 James Kim CEO, Kim Jae Mo 이사 CMO, Max Khoo 이사 CFO, Lee Jun Bong 이사, Park Ju-Jin 이사가 표시됩니다. Park Ju-Jin은 SearchOne, Tongil Trading, HighGood, CrossCoin Foundation의 이전 역할도 함께 기재되어 있습니다.', href: '#team', link: '팀 섹션', k: '팀 재단 말레이시아 ssm one company 이사 거버넌스 park ju-jin searchone tongil highgood crosscoin' },
    ...
    ja: {
      ...
      items: [
        ...
        { id: 'whitepaper', q: '詳細はどこで読めますか？', a: 'ホワイトペーパーが製品・技術の詳細リファレンスです。概要、製品論点、UX、アーキテクチャ、セキュリティ、トークンモデル、成長、ビジネスモデル、ロードマップ、チーム、リスク、用語集を扱います。', href: 'whitepaper.html', link: 'ホワイトペーパーを読む', k: 'whitepaper details documentation chapters glossary architecture' },
          { id: 'team', q: 'ONEWALLET のチームは？', a: '最新の財団アップデートでは、ONE COMPANY はマレーシアの SSM（Companies Commission of Malaysia）に登録されたマレーシア財団として記載されています。公開チームセクションには、CEO の James Kim、Director CMO の Kim Jae Mo、Director CFO の Max Khoo、Director の Lee Jun Bong と Park Ju-Jin が掲載されています。Park Ju-Jin には SearchOne、Tongil Trading、HighGood、CrossCoin Foundation での過去の役職も記載されています。', href: '#team', link: 'チームセクション', k: 'team founders governance foundation malaysia ssm one company directors people park ju-jin searchone tongil highgood crosscoin' },
    ...
    zh: {
      ...
      items: [
        ...
        { id: 'whitepaper', q: '在哪里阅读详细信息？', a: '白皮书是详细的产品和技术参考，涵盖执行摘要、产品论点、UX、架构、安全、代币模型、增长、商业模型、路线图、团队、风险和术语表。', href: 'whitepaper.html', link: '阅读白皮书', k: 'whitepaper details documentation chapters glossary architecture' },
          { id: 'team', q: 'ONEWALLET 团队是谁？', a: '最新基金会更新显示,ONE COMPANY 是在马来西亚 SSM（Companies Commission of Malaysia）注册的马来西亚基金会。公开团队部分列出 James Kim 为 CEO、Kim Jae Mo 为 Director CMO、Max Khoo 为 Director CFO、Lee Jun Bong 与 Park Ju-Jin 为 Director。Park Ju-Jin 还列有 SearchOne、Tongil Trading、HighGood 与 CrossCoin Foundation 的过往职务。', href: '#team', link: '团队部分', k: 'team founders governance foundation malaysia ssm one company directors people park ju-jin searchone tongil highgood crosscoin' },
