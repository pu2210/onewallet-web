...
const wpChapters = [
  ...
  { id: 'wp-ch4', title: 'Technical architecture — four layers', src: 'whitepaper.html#ch4', tags: ['architecture','edge','custody','settlement'],
    text: 'Layer 1 Client: Telegram Mini App, React + TMA SDK. Layer 2 Edge: auth, Shamir signing orchestration, price feeds, webhooks; stateless functions that hold no share; the key is reconstructed only transiently on the user device during signing. Layer 3 Custody (target architecture): signer service, recovery share registry, Telegram-share binding; isolated environment; hardware-protected share custody planned; holds no single signable key. Layer 4 Settlement: chain adapters, payment processor, indexer, merchant API; TON and EVM; idempotent settlement.' },
...
const homepageSections = [
  { id: 'hp-platform', title: 'Platform — a complete stack for Telegram-native money', src: 'index.html#platform', tags: ['platform','stack','overview'],
    text: 'Open a wallet inside a chat. QR rail, not a portfolio app. 2-of-3 Shamir, no single point of failure. Web3 acceptance with Web2 ergonomics. $1 powers the working layer.' },
